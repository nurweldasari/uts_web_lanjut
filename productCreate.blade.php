...
<head>
  ...
  <style>
    ...
    .btn-warning {
      background-color: #000; /* Warna hitam untuk tombol "RESET" */
      color: #fff; /* Warna teks putih */
    }
  </style>
</head>
          ...
          <div class="card-body">
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_bunga') is-invalid @enderror" name="nama_bunga" value="{{ old('nama_bunga') }}" placeholder="nama_bunga">
